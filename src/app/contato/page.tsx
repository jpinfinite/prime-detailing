...
export const metadata: Metadata = {
  ...
  description: "Entre em contato com o Detailing Prime. Dúvidas, sugestões ou parcerias.",
  openGraph: {
    title: "Contato - Detailing Prime",
    description: "Entre em contato conosco",
    url: "https://detailingprime.com.br/contato",
  },
};
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-text-primary text-center">
            Entre em <span className="text-prime-yellow">Contato</span>
          </h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-prime-gray-medium p-6 rounded-lg">
              <div className="w-12 h-12 bg-prime-yellow rounded-lg flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-prime-black" fill="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl font-bold mb-2 text-text-primary">Instagram</h3>
              <p className="text-text-secondary">@detailingprime</p>
            </div>
          </div>
